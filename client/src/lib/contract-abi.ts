export const SENTIMENT_NFT_ABI = [
  {
    "inputs": [],
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "indexed": false,
        "internalType": "enum SentimentNFT.RarityTier",
        "name": "newRarity",
        "type": "uint8"
      }
    ],
